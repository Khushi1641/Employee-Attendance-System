    ...
    <div>
      <table class="table">
        <thead>
            <?php
require 'dbconnect.php';
$qry = "SELECT * FROM salary WHERE isactive='1' AND usertype='Employee'";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="updateemployeesal.php?id=<?php echo $row['id']?>">Update</a></td>
            <td><a href="deleteemployeesal.php?id=<?php echo $row['id']?>">Delete</a></td>
        </tr>       
<?php    
    //}
    }
