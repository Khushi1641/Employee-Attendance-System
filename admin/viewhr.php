    ...
    <div>
      <table class="table">
        <thead>
            <?php
require 'dbconnect.php';
$qry = "SELECT * FROM attendance WHERE isactive='1' AND usertype='HR'";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="updatehr.php?id=<?php echo $row['id']?>">Update</a></td>
            <td><a href="deletehr.php?id=<?php echo $row['id']?>">Delete</a></td>
        </tr>       
<?php    
    //}
    }
