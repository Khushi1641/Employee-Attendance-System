	...
	<section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
             <section class="panel">
                    <header class="panel-heading">Update Manager</header>
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                require 'dbconnect.php';
                                $id=$_GET['id'];
                                $qry="SELECT * from attendance where isactive=1 AND id='".$id."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="date" placeholder="Enter Date " value="<?php echo $row['date'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="mno">Total Time : </label>
                                    <input type="text" class="form-control" name="t_time" placeholder="Enter Total" value="<?php echo $row['t_time'];?>">
                                </div>
                                <div class="form-group">
