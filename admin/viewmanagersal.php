    ...
    <div>
      <table class="table">
        <thead>
            <?php
require 'dbconnect.php';
$qry = "SELECT * FROM salary WHERE usertype='Manager' AND isactive=1";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="updatemanagersal.php?id=<?php echo $row['id']?>">Update</a></td>
            <td><a href="deletemanagersal.php?id=<?php echo $row['id']?>">Delete</a></td>
        </tr>       
<?php    
    //}
    }
