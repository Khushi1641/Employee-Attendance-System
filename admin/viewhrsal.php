    ...
    <div>
      <table class="table">
        <thead>
            <?php
require 'dbconnect.php';
$qry = "SELECT * FROM salary WHERE isactive='1' AND usertype='HR'";
...
?>
    ...
    <?php
        ...
        <tr>
            ...
            <td><a href="updatehrsal.php?id=<?php echo $row['id']?>">Update</a></td>
            <td><a href="deletehrsal.php?id=<?php echo $row['id']?>">Delete</a></td>
        </tr>       
<?php    
    //}
    }
