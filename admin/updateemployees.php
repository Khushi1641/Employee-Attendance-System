                    ...
                    <header class="panel-heading">Add Employee</header>
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="editemployees.php" method="POST">
                                <?php 
                                require 'dbconnect.php';
                                $id=$_GET['id'];
                                $qry="SELECT * from user where isactive=1 AND id='".$id."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Full Name" value="<?php echo $row['name'];?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="uname" placeholder="Enter Username" value="<?php echo $row['uname'];?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mno" placeholder="Enter Mobile no." value="<?php echo $row['mno'];?>">
                                </div>
                                <div class="form-group">
