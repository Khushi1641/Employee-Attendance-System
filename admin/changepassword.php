             ...
             <section class="panel">
                ...
                <?php } ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="op" placeholder="Enter Old Password">
                                </div>
                                <div class="form-group">
                                    <label for="uname">New Password : </label>
                                    <input type="text" class="form-control" name="np" placeholder="Enter New Password">
                                </div>
                                <div class="form-group">
                                    <label for="email">Confirm Password : </label>
                                    <input type="text" class="form-control" name="cp" placeholder="Enter Confirm Password">
                                </div>
